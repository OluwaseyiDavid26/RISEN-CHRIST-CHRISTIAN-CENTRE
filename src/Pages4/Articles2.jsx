...
const imageUrls = {
  article1: `${DRIVE_BASE_URL}13gScDB-c7QkQbo5OShHTvKvU2e2qZtqJ${DRIVE_SIZE}`,
  article2: `${DRIVE_BASE_URL}1I2fcYTLFvB4d5WRINt-8CmGJSXK8jPvO${DRIVE_SIZE}`,
  article3: `${DRIVE_BASE_URL}1LXmk2_MKMeFMD2YNF_sROnK9OhqDHoo9${DRIVE_SIZE}`,
  article4: `${DRIVE_BASE_URL}1rXEU3eGDWjhB-xFbb-MMVrLpXqJV2Fpm${DRIVE_SIZE}`,
  article5: `${DRIVE_BASE_URL}1Ny0yRetnnjDWX3cPgaxpzC2bSbYSbpqX${DRIVE_SIZE}`,
};
