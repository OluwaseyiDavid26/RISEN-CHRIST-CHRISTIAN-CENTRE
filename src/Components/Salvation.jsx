  ...
  return (
    <section className="w-full py-28 px-6 bg-dark-900 text-center relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          <Link to="/sinners">
            <button className="inline-flex items-center justify-center px-8 py-3.5 bg-gold-500 text-dark-900 font-semibold text-sm rounded-full hover:bg-gold-400 transition-all duration-300 hover:shadow-[0_8px_24px_rgba(107,63,160,0.3)] hover:-translate-y-0.5 active:scale-[0.98]">
