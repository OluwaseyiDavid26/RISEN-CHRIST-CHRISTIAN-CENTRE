...
const image10 = `${DRIVE_BASE_URL}1PxsmCo1jAerbg5chp2ZxHNOxr51CR-Ay`;
const image11 = `${DRIVE_BASE_URL}1KTddszP6MpPqYNHz4J9dPhyxcWVVcZD9`;
  ...
  return (
    <section className="flex flex-col lg:flex-row items-start gap-10 justify-between px-6 py-10">
      ...
      >
        ...
        <button className="border border-gray-800 px-4 py-2 rounded hover:bg-gray-600 hover:text-white transition">
          Read About Us
        </button>
      </motion.div>
